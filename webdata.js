...
const swtText = `（11/8 21:00）隨著熱帶氣旋「白海豚」逐漸減弱及遠離，受低層暖濕西南氣流影響，本澳天氣仍然酷熱，市區最高達36度，同時對流發展轉趨活躍。另外，與「白海豚」偏北風及西南氣流匯聚，該切變線會逐漸南壓，廣東驟雨增多及有雷暴，部分地區雨勢較大。市民應留意天氣變化。`;

//Alert Tips
const alertipsText = `高溫預警提示於本地時間08月04日12時40分發出。表示澳門高溫天氣持續。`;

//Weather Forecast
const forecastRaw = `隨著熱帶氣旋「白海豚」逐漸減弱及遠離，受低層暖濕西南氣流影響，本澳天氣仍然酷熱，市區最高達36度，同時對流發展轉趨活躍。另外，與「白海豚」偏北風及西南氣流匯聚，該切變線會逐漸南壓，廣東驟雨增多及有雷暴，部分地區雨勢較大。
...
更新時間：2026-08-11 21:00 MST
`;

// 氣溫
const chartRightDate = "2026-07-08-11 10:00 MST";
