...
const swtText = `（13/8 02:00）潤色版本（氣象推文語氣）

隨著熱帶氣旋「白海豚」殘餘環流持續深入內陸，將逐步與高空槽耦合。同時，西南季風再度活躍，重新主導華南的水汽輸送，該區相對濕度上升，再加上早前的長時間高溫天氣，大氣較為不穩定。今日開始，雖然日間天氣仍然酷熱，但下午至晚上局部強雷暴天氣將陸續發展，高溫天氣略為緩解。市民應留意天氣變化。`;
