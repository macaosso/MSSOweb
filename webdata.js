...
const tcWarnings = [
  ...
  {
    icon: "",
    text: "下午1時，熱帶低氣壓集結在本澳西南約490公里，即在北緯19.4度，東經109.9度附近，其中心附近最高持續風速約為每小時55公里，向西移動，時速10公里，橫過海南島，隨後在北部灣徘徊。"
  },
  {
    icon: "",
    text: ""
...
// ==========================================================================
const swtText = [
  "現時位於北部灣的熱帶氣旋預計在未來一兩日在該區徘徊及增強。隨後該熱帶氣旋有可能在下週初採取偏東路徑移動，再次靠近廣東西部沿岸，但仍然存在較大變數，本台會視乎其發展動向，評估再次發出熱帶氣旋警報的可能性。",
  "",
  ""
];
