...
const warnWarnings = [
  {
    icon: "",
    text: "豪雨特別報告於本地時間07月16日08時40分發出。表示本澳在未來24小時累積雨量有機會達到100毫米以上；或在過去24小時累積雨量已經/將有機會達到100毫米以上，且雨勢將會持續。受到低壓系統引進之西南氣流影響，廣東沿岸過去數日曾出現短時強降雨，本澳亦部份低窪地區可能出現水浸或積水；現時累積雨量高，大雨可引致泥土鬆軟，有山泥傾瀉風險，市民外出時應注意天氣及路面狀況。市民應完成適當的預防措施，避免在水浸地區進行活動及逗留在地下空間或無其他出口的空間；留意道路交通資訊，提防塌樹、山泥傾瀉等災害。"
  },
  {
    icon: "",
    text: ""
...
//Alert Tips
const alertipsText = `受西南氣流影響，本澳明日初時仍然有驟雨，亦有幾陣雷暴，部份地區雨勢較為頻密，市民需留意最新天氣資訊。（17:25 更新）`;
