const tcWarnings = [
  {
    text: "正午12時，強烈熱帶風暴「薔薇」集結在本澳東南偏東約1760公里，即北緯17.9度，東經129.8度，其中心附近最高持續風速約為每小時105公里，向西北移動，時速17公里，未來數日會逐漸增強，大致移向台灣以東海域至沖繩一帶。"
  },
];
...
const pastPoints = [
  ...
  {lat:16.8, lon:131.0, time: "05-30 02H", wind: 90}, 
  {lat:17.3, lon:130.2, time: "05-30 08H", wind: 105}, 
  {lat:17.9, lon:129.8, time: "05-30 12H", wind: 105}, 
];
...
const forecastPoints = [
  ...
  {lat:19.4, lon:128.7, time:"05-31 00H", wind: 120},
  {lat:21.2, lon:128.0, time:"05-30 12H", wind: 130},
  {lat:25.6, lon:127.6, time:"05-31 12H", wind: 155},
